...
const agents = [
  {
    ...
    bio: "결정은 늘 고객분의 몫이라고 생각하기에, 저는 재촉하기보다 기다리는 편입니다. 부동산 계약은 인생에서 가장 큰 결정 중 하나이기 때문에, 고객 한 분 한 분의 말씀을 끝까지 듣고 공감하는 것이 먼저라고 생각합니다. 특히 내 가족이 살 집을 고르는 엄마의 마음으로 함께하기 때문에, 고객이 무엇을 걱정하는지 누구보다 잘 압니다.\n\n공인중개사 자격증과 상가분석사 자격증을 바탕으로, 아파트 입지·실거래가·네이버부동산 호가를 교차 분석해 거품 없는 객관적인 정보를 드립니다. 고객님이 발품을 팔지 않아도 되도록, 조건에 딱 맞는 물건만 선별해 안내해 드려 소중한 시간을 지켜드립니다.\n\n계약 전 서류를 꼼꼼히 검토하여 분쟁 소지가 될 수 있는 부분은 반드시 미리 알려드립니다. 문제가 생긴 뒤 수습하는 것이 아니라, 처음부터 안전한 계약을 만드는 것이 진짜 전문가의 역할이라 믿습니다.",
    strengths: [
      { icon: ShieldCheck, label: "고압적 분위기 없는 상담", desc: "불필요한 압박 없이, 고객님의 페이스에 맞춰 진행합니다." },
